...
async function main() {
  ...
  const appleIcon = await makeLogoBuffer(badgeLogo, 180, 0.05);
  const icon192 = await makeLogoBuffer(badgeLogo, 192, 0.05);
  const icon512 = await makeLogoBuffer(badgeLogo, 512, 0.05);
