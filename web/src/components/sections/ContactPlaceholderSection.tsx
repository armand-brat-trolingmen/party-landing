        ...
        <article className={`${styles.frame} site-panel-glow`}>
          ...
          <div className={`${styles.noteCard} reveal-grid`} data-testid="contact-note">
            <p className={styles.noteText}>
              Это лишь 10% от того, что я видел в своей голове, и сделать я готов как угодно: от
              смены дизайна и стилистики до смены концепции сайта — от визитной карточки до
              чего-то другого и автоматического приема заказов с сайта с последующей
              переадресацией заказа в телеграм/т.п.
            </p>
          </div>
        </article>
      </div>
