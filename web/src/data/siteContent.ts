...
export const faqPlaceholderContent = {
  ...
  description:
    'Секция FAQ пока в черновом режиме и оформлена как чистый бланк под будущие ответы.',
  note: 'Скоро добавим вопросы и ответы. Сейчас оставили чистый блок для согласования структуры.',
};

export const contactPlaceholderContent = {
  eyebrow: 'Связаться с нами',
  description:
    'Скоро здесь появится полноценный контактный блок для быстрых заявок и вопросов по дате.',
  note: 'Пока можно написать нам в директ: оперативно подскажем формат и свободные даты.',
};
