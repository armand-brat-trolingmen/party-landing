  ...
  items: [
    {
      ...
      answer: 'Лучше написать сразу, как только у вас появились дата, площадка и примерное количество гостей. Так мы спокойно закрепим формат, подскажем по таймингу и соберем предложение без спешки и компромиссов по наполнению.',
    },
    {
      id: 'events',
