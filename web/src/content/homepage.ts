...
export const faq = {
  ...
  items: [
    {
      id: 'when-to-contact',
      question: 'За какой срок лучше оформить заказ?',
      answer:
        'Лучше написать сразу, как только у вас появились дата, площадка и примерное понимание по формату. Мы забронируем за вами дату, зафиксируем договорённости по составу и таймингу, чтобы мероприятие прошло точно в срок и со всеми согласованными условиями.',
    },
    {
      id: 'events',
      question: 'На какие праздники можно организовать сладкий кейтеринг?',
      answer: 'Наши станции хорошо работают на днях рождения, корпоративах, свадьбах, выпускных, школьных праздниках, городских фестивалях и семейных событиях. Мы подбираем формат под аудиторию и делаем так, чтобы зона не просто кормила гостей, а действительно усиливала впечатление от мероприятия.',
    },
    {
      id: 'rental',
      question: 'Что Вы получаете с арендой станции?',
      answer: 'В аренду входит не только оборудование, но и полноценная готовность точки к работе: монтаж, демонтаж, расходные материалы и специалист на площадке. Вам не нужно собирать процесс по частям, мы привозим формат в собранном коммерческом виде и ведем его до финала мероприятия.',
    },
    {
      id: 'technical-requirements',
      question: 'Есть ли технические требования для работы станций?',
      answer: 'Обычно достаточно ровной площадки и доступа к электропитанию, а по некоторым форматам мы заранее уточняем воду, подъезд и время монтажа. Если на площадке есть ограничения, мы подскажем безопасное решение заранее, чтобы в день события все прошло без накладок.',
    },
    {
      id: 'moscow-region',
      question: 'Работаете ли вы по Москве и Московской области?',
      answer: 'Да, мы регулярно выезжаем по Москве и Московской области. По Москве можно быстро зафиксировать понятную логистику, а по области мы заранее считаем маршрут и время прибытия, чтобы станция приехала вовремя и работала в нужный вам интервал.',
    },
    {
      id: 'other-region',
      question: 'Можно ли заказать ваши услуги в другой регион?',
      answer: 'Да, такие проекты возможны, особенно если речь о крупном событии, серии дат или расширенном составе услуг. В этом случае мы отдельно просчитываем логистику и команду, чтобы вы сразу получили реалистичное коммерческое предложение без скрытых сюрпризов.',
    },
  ],
} as const;
...
export const homepage = {
    ...
    items: [
      {
        ...
        imageWebpSrcSet: '/images/food-truck-rental/rental-food-truck-1.webp',
        alt: 'Черный фудтрак MobiTruck SL-7 для аренды',
        width: 1120,
        height: 1493,
      },
      {
        image: '/images/food-truck-rental/rental-food-truck-2.jpg',
        imageWebpSrcSet: '/images/food-truck-rental/rental-food-truck-2.webp',
        alt: 'Красный фудтрак MobiTruck SL-5 для аренды',
        width: 1120,
        height: 840,
      },
      {
        image: '/images/food-truck-rental/rental-food-truck-3.jpg',
  ...
  foodTrucks: {
    ...
    items: [
      {
        image: '/images/food-trucks/food-truck-1.jpg',
        imageWebpSrcSet: '/images/food-trucks/food-truck-1.webp',
        alt: 'Фудтрак для кейтеринга на выездном мероприятии, фото 1',
        width: 1280,
        height: 960,
      },
      {
        image: '/images/food-trucks/food-truck-2.jpg',
      ...
      },
      {
        ...
        imageWebpSrcSet: '/images/food-trucks/food-truck-3.webp',
      ...
      },
      {
        ...
        imageWebpSrcSet: '/images/food-trucks/food-truck-5.webp',
        alt: 'Фудтрак для кейтеринга на выездном мероприятии, фото 5',
        width: 1280,
        height: 960,
      },
      {
        image: '/images/food-trucks/food-truck-6.jpg',
